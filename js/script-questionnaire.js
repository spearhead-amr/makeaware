...
function updateValues() {
	pills_y_top = document.getElementById('questionnaire-body').offsetTop;
...
document.addEventListener('scroll', (e) => {
	...
	if(window.scrollY > getQuestionnaireBodyYTop()) {
...
function menuPaddingIndex() {
	document.getElementById('questionnaire-head').style.paddingTop = header_fixer_height_index + 'px';
}
...
function getQuestionnaireBodyYTop() {
	updateValues();
	return pills_y_top;
}
