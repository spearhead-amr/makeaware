...
// Simple font loading detection for development
function waitForFontsAndCSS() {
  return new Promise((resolve) => {
    ...
    // Simple CSS check - wait for document to be fully loaded
    if (document.readyState === 'complete') {
      cssReady = true;
      if (fontsReady) resolve();
    } else {
...
document.addEventListener('DOMContentLoaded', function() {
  // Wait for fonts and CSS, then show content and start component loading
  waitForFontsAndCSS().then(() => {
    showContent();
